...
<div class="container">
    <div class="body">
        <p>New Withdrawal Confirmation from {{ $data['fname'] }} ({{ $data['email'] }}).</p>
        <table>
            <tr>
                <td class="title-table" colspan="2" style="font-size: 1.3em; padding: 20px 0;">
                    <strong>Withdrawal</strong> details</td>
            </tr>
            <tr>
            ...
            @if( $data['ordertype'] == 'Metal')
                ...
                <tr>
                    <td style="text-align: left;" class="title-table">Whitdrawall Total</td>
                    <td style="text-align: right;">{{ number_format($data['total'],4) }} Oz</td>
                </tr>
            @else
                <tr>
                    <td style="text-align: left;" class="title-table">Whitdrawall Currency</td>
                    <td style="text-align: right;">{{ $data['curr_or_metal'] }}</td>
                </tr>
                <tr>
                    <td style="text-align: left;" class="title-table">Whitdrawall Total</td>
