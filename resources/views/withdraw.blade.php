...
@push('scripts')
    <script type="text/javascript" src="{{ URL::to('/') }}/js/withdrawal.js?ver=1.2.0"></script>
@endpush

@section('content')
    <div class="page-container container">
        <div class="title-page-1">Withdrawal</div>
        <div class="coins-container" style="margin-top: 20px;">
            ...
            <div class="cash-container" data-name="usd">
                ...
                <a href="/whitdrawal-cash?currency=USD">USD <span class="coin-name">(USD Cash)</span></a>
            </div>
            <div class="cash-container" data-name="cad">

                <a href="/whitdrawal-cash?currency=CAD">CAD <span class="coin-name">(CAD Cash)</span></a>
            </div>
            <div class="cash-container" data-name="eur">

                <a href="/whitdrawal-cash?currency=EUR">EUR <span class="coin-name">(EUR Cash)</span></a>
            </div>
